...
public class OptionsApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            // Load the FXML file for the options screen
            FXMLLoader loader = new FXMLLoader(HelloApplication.class.getResource("options.fxml"));
            AnchorPane root = loader.load();

            // Set the scene with the loaded root
            Scene scene = new Scene(root);
            primaryStage.setTitle("Carry The Car - Options");
